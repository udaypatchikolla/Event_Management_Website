      ...
      <div className="ml-12 bg-gray-100 shadow-lg mt-8 p-16 w-3/5 float-left">
          ...
          <div className="mt-10 space-y-4">
            ...
            <div className="ml-10 flex gap-3">
              <button type="button" onClick={()=>setSelectedMethod('card')} className={`px-4 py-2 rounded-sm border ${selectedMethod==='card' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-300'}`}>Card</button>
              <button type="button" onClick={()=>setSelectedMethod('upi')} className={`px-4 py-2 rounded-sm border ${selectedMethod==='upi' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-300'}`}>UPI</button>
              <button type="button" onClick={()=>setSelectedMethod('netbanking')} className={`px-4 py-2 rounded-sm border ${selectedMethod==='netbanking' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-300'}`}>NetBanking</button>
              <button type="button" onClick={()=>setSelectedMethod('wallet')} className={`px-4 py-2 rounded-sm border ${selectedMethod==='wallet' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-300'}`}>Wallet</button>
            </div>
              ...
              <>
                ...
                <div className="flex space-x-4">
                  ...
                  <input
                    ...
                    onChange={handleChangePayment}
                    placeholder="CVV"
                    className="input-field w-20 h-10 bg-gray-50 border border-gray-30 rounded-sm p-3"
                  />
                </div>
              </>
            )}
            ...
            {selectedMethod === 'upi' && (
              <div className="ml-10">
                <input
                  ...
                  className="input-field w-96 h-10 bg-gray-50 border border-gray-30 rounded-sm p-2.5"
                />
              </div>
            )}
            ...
            {selectedMethod === 'wallet' && (
              <div className="ml-10 text-sm text-gray-700">
                Use your in-app wallet balance to complete the purchase. You can manage funds in the Wallet section.
              </div>
            )}
